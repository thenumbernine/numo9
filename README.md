...
- 0x40 = Apply a high-dynamic-range bloom.  Set this while rendering any geometry you want to apply HDR bloom to, and set this upon frame end to tell the renderer to apply the post-processing HDR pass.
- 0x80 = Apply a depth-of-field blur.  Set this while rendering any geometry you want to apply depth-of-field-blur to, and set this upon frame end to tell the renderer to apply the post-processing DoF pass.
...
There's some DoF variables in RAM too.
...
- voxelmap undo is broken, it breaks something with the GPU, because my half-baked attempt to GPU cache voxel chunks.
