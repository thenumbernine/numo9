...
--poke(ramaddr'useHardwareLighting', -1)		-- TODO uint8[0] = cast(uint32_t, -1) WILL ASSIGN A ZERO!!!! WHY?!?!?!
...
--poke(ramaddr'lights', -1)	-- TODO uint8[0] = cast(uint32_t, -1) WILL ASSIGN A ZERO!!!! WHY?!?!?!
