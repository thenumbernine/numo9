...
What happens if we've only written one of our many color attachments?
The rest get a default version?
what I should be doing here instead is disabling the color attachments that i'm not using...
what I should be doing is splitting this into 4 different renderers per-path, and maybe 8 x2 for lighting vs no lighting, maybe more...
*/
